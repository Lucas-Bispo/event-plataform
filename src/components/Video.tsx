                    ...
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-4">
                            <img 
                                    ...
                                    src="https://github.com/Lucas-Bispo.png" 
                                    alt="" />
                            
                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block" >Lucas Bispo</strong>
                                <span className="text-gray-200 text-sm block">Analista e Desenvolvedor</span>
                            </div>
